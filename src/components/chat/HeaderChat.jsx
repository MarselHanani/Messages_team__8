...
export function HeaderChat({ userData, chatId, otherUser }) {
  ...
  return (
    <div className="h-15 d-flex align-items-center justify-content-between border-1 border-bottom border-secondary-light">
      ...
      <div className="row w-media m-media ps-5 yahya-icons-position">
        <div className="col-4 col-md-3 col-sm-1 m-media-right">
          <i className="fa-solid fa-phone me-2 bg-circle text-center pt-2 m-media-right fs-6"></i>
        </div>
        <div className="col-4 col-md-3 col-sm-1 m-media-right">
          <i className="fa-solid fa-video me-2 bg-circle text-center pt-2 m-media-right fs-6"></i>
        </div>
